...
const ActivitiesBlock = ({src, title, onEditClick, onDeleteClick} : Props)  =>{
    ...
    return (
        <div className="relative flex flex-col items-center justify-center p-0">  
          <div className="relative w-full h-24"> 
            ...
            {/* <Image src={src} alt="image" layout="responsive" width={100} height={100} onClick={()=> setShowAction(true)} className="text-center h-auto rounded-xl"/> */}
            <p className="text-center text-sm leading-3 justify-self-end mt-2">{title}</p>
            ...
            <div className="flex justify-center rounded-xl border border-black-500 items-center cursor-pointer py-0.5 px-2 gap-0.5 text-[#fff] mb-2" onClick={onEditRecentClick}>
                <Image src={Edit} alt="photo" width={16} height={16} className="text-white"/>
                <p className="uppercase text-xs sm:text-sm">edit</p>
            </div>
            <div className="flex justify-center rounded-xl border border-g items-center cursor-pointer py-0.5 px-2 gap-0.5 text-[#fff]" onClick={onDeleteRecentClick}>
                <Image src={Delete} alt="photo" width={16} height={16} className="text-red-500 fill-white stroke-[#fff]"/>
                <p className="uppercase text-xs sm:text-sm">delete</p>
            </div>
                </div>
            }
